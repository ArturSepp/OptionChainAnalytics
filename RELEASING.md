...
The approved release target is `2.0.0`. It distinguishes the Python 3.14/src-layout release from
the already-published `1.1.4`. The tag, GitHub Release, package upload, and Pages deployment must
all refer to the same verified release commit and artefacts.

## Candidate verification

From a clean Python 3.14 environment:
...
5. Tag the verified commit `v2.0.0`, publish the same artefact to PyPI, create the GitHub Release,
