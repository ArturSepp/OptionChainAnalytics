...
from option_chain_analytics.data.config import OptionTickerConfig, FutureTickerConfig, get_ttm_from_dates, DeltaType

# pricers
import stochvolmodels.pricers.core.normal_pricer as nor
...
class TsData:
    ...
    def get_spot_data(self, time_period: qis.TimePeriod = None) -> pd.DataFrame:
        df = self.spot_data
